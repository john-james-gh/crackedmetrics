    ...
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route path="account" element={<div>Account Layout</div>}>
          <Route index element={<h1>Account Overview/List of Org and Create Org Button via Modal</h1>} />
        ...
        <Route path=":organizationId" element={<div>Organization Layout</div>}>
          <Route index element={<h1>Org Overview/List of Projects and Create Project Button via Modal</h1>} />
          ...
          <Route path=":projectId" element={<div>Project Layout</div>}>
            ...
            <Route path="reports" element={<h1>List Of Reports / Create Report Button via Modal</h1>} />
